...
# Global variables
VERSION = importlib.metadata.version("sbayt-cli")
DEFAULT_ENV = "dev"
...
def configure_uv(ctx, load_secrets_from_bws=None, deployment_file=None):
    ...
    logging.info(f"✅ uv is now configured to use the private CodeArtifact repository.")
...
def create_ca_env_file(ctx, deployment_file=None):
    ...
    print("\n---")
    print(f"To use the .env.codeartifact file with docker-compose, run:")
